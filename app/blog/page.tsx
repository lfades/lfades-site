      ...
      <Terminal title="luis@alvarez: ~/blog">
        <div className="p-4">
          <div className="mb-4 text-ctp-green">
            <span className="text-ctp-blue">luis@alvarez</span>:<span className="text-ctp-mauve">~/blog</span>$ ls -la
          </div>
            ...
            {blogPosts.map((post) => (
              ...
              >
                ...
                <div className="col-span-9">
                  <Link href={`/blog/${post.slug}`} className="text-ctp-blue hover:text-ctp-lavender hover:underline">
                    {post.title}
                  </Link>
                </div>
              </div>
          ...
          <div className="mt-4 text-ctp-green">
            <span className="text-ctp-blue">luis@alvarez</span>:<span className="text-ctp-mauve">~/blog</span>${" "}
